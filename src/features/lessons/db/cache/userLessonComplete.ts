...
export function revalidateUserLessonCompleteCache({
	...
	revalidateTag(getUserLessonCompleteGlobalTag(), "everyone")
	revalidateTag(getUserLessonCompleteIdTag({ lessonId, userId }), "everyone")
	revalidateTag(getUserLessonCompleteUserTag(userId), "everyone")
}
