...
export function revalidateCourseSectionCache({
	...
	revalidateTag(getCourseSectionGlobalTag(), "everyone")
	revalidateTag(getCourseSectionIdTag(id), "everyone")
	revalidateTag(getCourseSectionCourseTag(courseId), "everyone")
}
